        ...
        case 'project': {
            ...
            switch (sub) {
                ...
                case 'list':
                    ...
                    break;
                case 'transfer':
                    (0, config_js_1.error)('project transfer has moved — use app.safe.global to transfer via multisig.');
                    break;
                case 'collab':
                    (0, config_js_1.error)('project collab has moved — use app.safe.global for collaborator management.');
                    break;
                default:
