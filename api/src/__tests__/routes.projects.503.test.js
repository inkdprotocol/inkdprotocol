...
// ─── Tests ────────────────────────────────────────────────────────────────────
(0, vitest_1.describe)('GET /v1/projects — requireRegistry() ServiceUnavailable (503)', () => {
...
(0, vitest_1.describe)('GET /v1/projects/:id — requireRegistry() ServiceUnavailable (503)', () => {
    (0, vitest_1.it)('returns 503 when registry address is not configured', async () => {
        const app = await makeApp();
...
(0, vitest_1.describe)('GET /v1/projects/:id/versions — requireRegistry() ServiceUnavailable (503)', () => {
    (0, vitest_1.it)('returns 503 when registry address is not configured', async () => {
        const app = await makeApp();
...
(0, vitest_1.describe)('POST /v1/projects/:id/versions — requireRegistry() ServiceUnavailable (503)', () => {
    (0, vitest_1.it)('returns 503 when registry address is not configured', async () => {
        const app = await makeApp();
...
//# sourceMappingURL=routes.projects.503.test.js.map